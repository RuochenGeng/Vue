    ...
    <el-card>
      ...
      <el-table :data="orderlist" border stripe>
        ...
        <el-table-column label="操作">
          <template>
            <el-button type="primary" size="mini" icon="el-icon-location" @click="showProgressBox"></el-button>
            <el-button type="success" size="mini" icon="el-icon-edit" @click="showBox"></el-button>
          </template>
        </el-table-column>
      </el-table>
